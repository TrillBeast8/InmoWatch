...
/**
 * Optimized Universal input profile with direct delegation for maximum performance
 */
class UniversalInputProfile(private val hidInputManager: HidInputManager) : InputProfile {

    // Direct delegation for all methods - no redundant processing
    ...
    override fun sendScroll(deltaX: Float, deltaY: Float): Boolean =
        hidInputManager.sendMouseScroll(deltaX, deltaY)
